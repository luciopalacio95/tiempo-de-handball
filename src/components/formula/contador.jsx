  ...
  useEffect(() => {
    ...
    return (
        <>  
            ...
            <div className="w-full sm:w-3/4 mt-10 sm:mt-14 flex flex-row items-center justify-between m-auto mb-6">
                {!invertido ? (
                    ...
                    <div className="flex-basis-1/4">
                        <input type="text" name="local" autoComplete="off" placeholder={intl.formatMessage({ id: "general.local" })} value={local} onChange={(e) => setLocal(e.target.value)} className="bg-plate uppercase text-center text-white text-base sm:text-4xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-grey dark:focus:ring-gray-100 dark:focus:border-gray-100" />
                        <button onClick={() => setLocalGoles(localGoles + 1)} className="bg-white rounded-xl text-center text-gray-900 mt-6 text-4xl sm:text-8xl font-extrabold focus:ring-blue-500 focus:border-blue-500 block m-auto w-24 sm:w-full p-2.5 dark:bg-white">{localGoles}</button>
                         <div className="flex mt-2 flex-row items-center justify-between">
                            <button onClick={() => setLocalGoles(localGoles > 0 ? localGoles - 1 : 0)} className="bg-[#E91E63] rounded-full text-center text-gray-900 mt-6 text-4xl sm:text-6xl font-extrabold block w-16 sm:w-20 p-2.5"> - </button>
                            <button onClick={() => setLocalGoles(localGoles + 1)} className="bg-[#03A9F4] rounded-full text-center text-gray-900 mt-6 text-4xl sm:text-6xl font-extrabold block w-16 sm:w-20 p-2.5"> + </button>
                        </div>
                    </div>
                )}
                <div className="flex-basis-1/4">
                    <button disabled={activo === true} onClick={toggleOrden} className="bg-white d-block rounded-full sm:rounded-xl text-center text-gray-900 sm:mt-6 text-xl font-extrabold focus:ring-blue-500 focus:border-blue-500 block w-full p-2 sm:p-2.5 dark:bg-white">
                    <img 
                        src={cambio}
                        className='img-responsive w-auto h-8 sm:h-8'
                        alt='logo'
                    />
                    </button>
                </div>
                {!invertido ? (
                    <div className="flex-basis-1/4">
                        <input type="text" name="local" autoComplete="off" placeholder={intl.formatMessage({ id: "general.local" })} value={local} onChange={(e) => setLocal(e.target.value)} className="bg-plate uppercase text-center text-white text-base sm:text-4xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:placeholder-gray-400 dark:text-grey dark:focus:ring-gray-100 dark:focus:border-gray-100" />
                        <button onClick={() => setLocalGoles(localGoles + 1)} className="bg-white rounded-xl text-center text-gray-900 mt-6 text-4xl sm:text-8xl font-extrabold focus:ring-blue-500 focus:border-blue-500 block m-auto w-24 sm:w-full p-2.5 dark:bg-white">{localGoles}</button>
                        <div className="flex mt-2 flex-row items-center justify-between">
                            <button onClick={() => setLocalGoles(localGoles > 0 ? localGoles - 1 : 0)} className="bg-[#E91E63] rounded-full text-center text-gray-900 mt-6 text-4xl sm:text-6xl font-extrabold block w-16 sm:w-20 p-2.5"> - </button>
                            <button onClick={() => setLocalGoles(localGoles + 1)} className="bg-[#03A9F4] rounded-full text-center text-gray-900 mt-6 text-4xl sm:text-6xl font-extrabold block w-16 sm:w-20 p-2.5"> + </button>
            ...
            <div className="w-full px-[8rem] flex flex-col items-center justify-center">
                ...
                <div className="mt-6 flex flex-row items-center justify-evenly">
                    <span className="rounded-xl text-center text-gray-900 text-4xl sm:text-8xl font-extrabold block w-48 sm:w-96 py-2.5 px-2 sm:px-20 bg-white">
